class Admin::ProvincesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @province.save
        ...
        format.json { render :show, status: :created, location: admin_province_path(@province) }
      else
  ...
  def update
    respond_to do |format|
      if @province.update(province_params)
        ...
        format.json { render :show, status: :ok, location: admin_province_path(@province) }
      else
  ...
  private
    ...
    def province_params
      params.require(:province).permit(:name, :tax)
    end
end
