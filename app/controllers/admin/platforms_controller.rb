class Admin::PlatformsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @platform.save
        format.html { redirect_to admin_platform_path(@platform), notice: 'Platform was successfully created.' }
        format.json { render :show, status: :created, location: admin_platform_path(@platform) }
      else
  ...
  def update
    respond_to do |format|
      if @platform.update(platform_params)
        format.html { redirect_to admin_platform_path(@platform), notice: 'Platform was successfully updated.' }
        format.json { render :show, status: :ok, location: admin_platform_path(@platform) }
      else
